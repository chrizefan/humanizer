/*
  ...
  1. New Tables
    - `users`: Extends auth.users with additional user data
    - `projects`: Stores user's humanization projects
...
-- Function to automatically create a user record when a new auth user signs up
